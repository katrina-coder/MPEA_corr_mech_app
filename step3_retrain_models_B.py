...
FEATURE_COLS = ELEM_COLS + PROCESS_COLS + EMP_COLS   # 54 features
...
# Back-transform icorr from log scale
imp_df[icorr_col] = 10 ** imp_df['icorr_log']
...
train_unified_regressor('icorr',          'Corrosion current density (microA/cm2)',
                        log_scale=True, filename='icorr_regressor.joblib')
